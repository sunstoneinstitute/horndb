...
- [v] **MEDIUM** · _Completeness_ — SPEC-07 SPARQL (property paths, full `Update`, GSP, `EXPLAIN`, …) ([#7](https://github.com/sunstoneinstitute/horndb/issues/7)) — _wip: 122d0f80@Stigs-MacBook-Pro.local · task-7-graph-mgmt-update · 2026-06-18T06:15:14Z_
