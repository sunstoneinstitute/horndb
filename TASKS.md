...
- [v] **HIGH** · _Performance_ — SPEC-03 NF1: close `per_tuple` hot-path overhead (depth-1 leapfrog + Arrow materialization, not SIMD) — spun out of #132 ([#237](https://github.com/sunstoneinstitute/horndb/issues/237)) — _wip: 10fc5585@Stigs-MacBook-Pro.local · task-237-spec-03-nf1-close-per-tuple-hot-path-ove · 2026-07-20T09:43:22Z_
...
- [v] **SPEC-03 NF1: close `per_tuple` hot-path overhead.** ([#237](https://github.com/sunstoneinstitute/horndb/issues/237))
...
- [ ] **SPEC-25 S1: per-tuple MVCC visibility + delete path.** ([#225](https://github.com/sunstoneinstitute/horndb/issues/225))
