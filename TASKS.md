...
- [ ] **CRITICAL** · _Operational_ — SPEC-26 Phase 2: query-scoped URL-param overrides + enforcement (timeout / row-cap / rdf12; memory stub) — after #250 ([#251](https://github.com/sunstoneinstitute/horndb/issues/251))
