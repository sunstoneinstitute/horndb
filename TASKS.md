...
- [v] **MEDIUM** · _Completeness_ — SPEC-07 SPARQL (property paths, full `Update`, GSP, `EXPLAIN`, …) ([#7](https://github.com/sunstoneinstitute/horndb/issues/7)) — _wip: 122d0f80@Stigs-MacBook-Pro.local · task-7-property-paths-alt-neg-opt · 2026-06-18T04:20:29Z_
