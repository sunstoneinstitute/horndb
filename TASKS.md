...
- [v] **MEDIUM** · _Completeness_ — SPEC-04 rules (`dt-*`, `cls-maxc*`, proof recording, …) ([#4](https://github.com/sunstoneinstitute/horndb/issues/4)) — _wip: 4cc950ec@Stigs-MacBook-Pro.local · task-4-prp-adp · 2026-06-16T08:49:04Z_
...
- [v] **SPEC-04 rules.** ([#4](https://github.com/sunstoneinstitute/horndb/issues/4))
  Remaining: `prp-adp` ([#37](https://github.com/sunstoneinstitute/horndb/issues/37)),
