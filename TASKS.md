...
- [ ] **HIGH** · _Performance_ — SPEC-03 NF1: close `per_tuple` hot-path overhead (depth-1 leapfrog + Arrow materialization, not SIMD) — spun out of #132 ([#237](https://github.com/sunstoneinstitute/horndb/issues/237))
...
- [ ] **SPEC-03 NF1: close `per_tuple` hot-path overhead.** ([#237](https://github.com/sunstoneinstitute/horndb/issues/237))
