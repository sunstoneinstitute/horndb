...
//! [`normalize`], [`filter_pullup`], [`filter_pushdown`], and
//! [`projection_pushdown`].
//!
...
/// — the legality test [`filter_pullup`] and [`filter_pushdown`] read to
/// decide whether a predicate can move past a subtree without changing
/// which rows survive.
