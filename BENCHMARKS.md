...
| `spec05_incremental_append` — single-edge append on a 2,000-node chain | incremental ≪ full recompute | this PR (macOS dev workstation, 2026-06-01): incremental_insert **393 µs** vs full_recompute **453 ms** (~**1,153×**). Insertion-only F6; differential-proven equal to GraphBLAS closure. |
