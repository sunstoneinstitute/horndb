...
- [`adr/`](adr/README.md) — Architecture Decision Records (21 so far), one decision per file. Read for the rationale behind a choice; `architecture.md` has current status.
