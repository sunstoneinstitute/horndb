...
- Working on the Python API (native `Store` or rdflib compatibility)? Read [`specs/SPEC-10-rdflib-compatible-python-api.md`](specs/SPEC-10-rdflib-compatible-python-api.md) and the native-spine design spec [`specs/2026-06-20-pyoxigraph-style-python-store.md`](specs/2026-06-20-pyoxigraph-style-python-store.md) (plan: [`plans/2026-06-20-python-native-store.md`](plans/2026-06-20-python-native-store.md)), then [`rdflib.md`](rdflib.md) and the binding crate `crates/python/` (CLAUDE.md + README). Importable as `horndb`: the native pyoxigraph-shaped `Store` (named graphs, `quads_for_pattern`, `load`/`serialize`, `query`/`update`, OWL 2 RL `materialize()`) plus the `horndb.rdflib` compat facade. Differential gate is `crates/python/tests/` + [`harness/curation/rdflib-compat.md`](../harness/curation/rdflib-compat.md). The crate is off the Cargo workspace so `cargo build/test/clippy --workspace` stays Python-free.
