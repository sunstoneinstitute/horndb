...
- Working on query/update behavior? Read [`specs/SPEC-07-sparql-frontend.md`](specs/SPEC-07-sparql-frontend.md) and then [`rdflib.md`](rdflib.md). Active plan: [`plans/2026-06-08-SPEC-07-wcoj-bgp-executor.md`](plans/2026-06-08-SPEC-07-wcoj-bgp-executor.md) — wiring BGP eval onto `horndb-wcoj` (#67). Delivered: [`plans/2026-06-10-task-66-sparql-expression-surface.md`](plans/2026-06-10-task-66-sparql-expression-surface.md) — expression surface (arithmetic/`IF`/`COALESCE`/builtins) + `GRAPH` lowering (#66).
