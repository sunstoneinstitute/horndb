...
status: executed
date: 2026-06-27
scope: "SPEC-12 Stage 2 — Dictionary decode + columnar partition scan SIMD"
---
...
This plan delivers SPEC-12 **F2** and gates acceptance criterion **#4** (dictionary decode ≥4× scalar; `rdf:type` partition scan ≥80% STREAM-Triad — jointly satisfies SPEC-02 acceptance #4). **Prerequisite:** `PLAN-12-01-simd-primitives.md` is merged.
