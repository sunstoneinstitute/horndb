...
**Reference spec:** `docs/specs/2026-06-29-metrics-design.md` §7.2 (wcoj), §5.3 (the per-tuple prohibition — this slice is the canonical place that boundary matters). Epic: #148.
