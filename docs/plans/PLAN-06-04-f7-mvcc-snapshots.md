...
status: executed
date: 2026-06-17
scope: "SPEC-06 F7 — In-flight Reader Visibility (MVCC Snapshots)"
---
...
```bash
git add crates/incremental/FUTURE-WORK.md crates/incremental/CLAUDE.md docs/architecture.md docs/plans/PLAN-06-04-f7-mvcc-snapshots.md
