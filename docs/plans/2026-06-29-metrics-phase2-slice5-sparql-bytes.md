...
**Reference spec:** `docs/specs/2026-06-29-metrics-design.md` §7.1 (deferral note), §7.2 (the fan-out item). Epic: #148. Note commit `d2cace9` removed a permanently-zero `response_bytes` series in Slice 1; this slice adds it back properly.
