...
status: executed
date: 2026-06-27
scope: "SPEC-12 Stage 1b — WCOJ SIMD seek + intersect"
---
...
This plan delivers SPEC-12 **F1** and gates acceptance criteria **#2** (`per_tuple` ≤2.5 ns/tuple), **#3**'s WCOJ-side intersect bench, and **#5** (WCOJ differential fuzzer stays green). **Prerequisite:** `PLAN-12-01-simd-primitives.md` is merged.
