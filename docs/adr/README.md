...
| [0015](0015-vendor-graphblas-static-submodule.md) | ~~Vendor SuiteSparse:GraphBLAS as a static git submodule~~ (superseded by 0019) | SPEC-05 |
...
| [0022](0022-sparql-entailment-regimes-claimed.md) | **Proposed:** which SPARQL entailment regimes HornDB claims — and how a declined regime is reported without inflating the conformance headline (bears on SPEC-07 AC2) | SPEC-01, SPEC-04, SPEC-07 |
