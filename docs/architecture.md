...
The rest of the Stage-2 completeness work — DeltaLog WAL, MVCC backing of
snapshots, and the bilinear-join runtime — remains **planned** under
`SPEC-24` (epic
[#186](https://github.com/sunstoneinstitute/horndb/issues/186)), decomposed
into `TASKS.md` phase tasks
[#214](https://github.com/sunstoneinstitute/horndb/issues/214)–[#217](https://github.com/sunstoneinstitute/horndb/issues/217).
