...
`crates/storage`, `crates/owlrl` · **Spec:** `SPEC-12` · **Overall status: partially implemented** (primitives crate + WCOJ seek/intersect consumer landed; storage `rdf:type` scan + delta-apply consumers still specified)
