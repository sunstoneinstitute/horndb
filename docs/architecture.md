...
decomposition to minimise intermediate Z-set size" — is therefore
**implemented**: n-ary decomposition is cost-ordered over the SPEC-23 `Stats`
seam. A sort-merge kernel and codegen emitting kernel instances are still
planned. The intra-tick joint
