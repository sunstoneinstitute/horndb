...
| Kleene-star property paths (`*`, `+`) | **planned** | `UnsupportedPathOp`; needs closure-on-demand or backward chaining. Tracked under the SPEC-07 umbrella (#7), increment [#50](https://github.com/sunstoneinstitute/horndb/issues/50). |
