...
*closure* path is `SPEC-24` S2. The rest of the Stage-2 completeness work —
...
[#211](https://github.com/sunstoneinstitute/horndb/issues/211)–[#217](https://github.com/sunstoneinstitute/horndb/issues/217).
